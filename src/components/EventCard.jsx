...
const EventCard = ({imageSrc, category, title, date, endDatetime, venueName, venueCity}) => (
    <div className="p-4 md:w-1/3">
        <div className="flex flex-col h-full p-5 bg-white rounded-xl shadow text-zinc-500">
            ...
            <div className="mt-1 text-neutral-600">Starts at: {date}</div>
            <div className="mt-1 text-neutral-600">Ends at: {endDatetime}</div>
